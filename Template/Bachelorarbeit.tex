...
%Bei zusaetzlichen Publishing-Angaben mittels \hsfurthereditionnotes kann eine
%Verkleinerung der Schriftgröße dieser Angaben hiermit erreicht werden
smallereditionnotes=true,
...
%%% Fuer Veroeffentlichungen interessant, Inhalt ist exemplarisch
%\hsfurthereditionnotes{
%Dokumentenversion: 1.2\\[1ex]
%ISSN: 1234-5678\\
%ISBN: 1234567890-Y \qquad\qquad\qquad\qquad\qquad\qquad ISBN (eBook): 1234567890-Z\\
%DOI: 12345678901234.1
%}
